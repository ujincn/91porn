...
request_headers = {
    ...
    # "Cookie": '__cfduid=d9c91fd06c1ac129d889eb4bb9336dafe1499854140; 91username=ak2500; language=cn_CN;
    # __dtsu=D9E9B66B43F565597177864F02112562; CLIPSHARE=lluj4gh7q6pkrii83km76mlj62; watch_times=3;
    # DUID=2e19XHcpaC5xpJIIZ6bk5fcXQeeD9tuCsi%2FP%2Fwj4B8UbHr71;
    # USERNAME=ad470Men1Sdz%2FxSPWGhEeyF%2B9qmpH8VETA49p9e7pqvhfjQ; user_level=1; EMAILVERIFIED=no; level=1;
    # __utma=50351329.847118676.1499854140.1503538554.1503542738.10; __utmb=50351329.0.10.1503542738;
    # __utmc=50351329; __utmz=50351329.1499854140.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none);
    # AJSTAT_ok_pages=3; AJSTAT_ok_times=8'
}
...
def login_and_get_cookie(url):
    ...
    req = urllib.request.Request(url, post_data, headers=request_headers)
